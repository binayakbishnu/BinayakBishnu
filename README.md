...
| --- | --- |
| 👋 Hi, I’m Binayak Bishnu<br />🎯 An aspiring **Data Analyst**<br />🎯 Long-term goal of **Data Science**<br />🧑‍💻 `Python` `SQL` `R`<br />🧑‍💻 `C`, `C++`<br />🧑‍💻 `HTML` `CSS` `JS`<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&gt; `Bootstrap`<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&gt; `Reactjs`  `Nodejs`<br />⚙️ `Git` `Tableau` `MongoDB`<br />🌱 `UI/UX`<br />🌱 `painting` and `music`<br /><br />Reach me:<br />https://www.linkedin.com/in/binayakbishnu<br />https://github.com/binayakbishnu<br />https://www.instagram.com/binayakbishnu | <!-- <a href="https://app.daily.dev/binayak_bishnu"><img src="https://github.com/BinayakBishnu/BinayakBishnu/blob/master/devcard.svg" width="300" alt="Binayak's Dev Card"/></a> --><a href="https://app.daily.dev/binayak_bishnu"><img src="https://api.daily.dev/devcards/e692f68d8d3445acbdc0e8297e12b35d.png?r=a2e" width="300" alt="Binayak Bishnu's Dev Card"/></a> |
